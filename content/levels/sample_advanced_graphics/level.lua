...
pewpew.customizable_entity_set_mesh(background1, "/dynamic/polar_graphic.lua", 0)

local background2 = pewpew.new_customizable_entity(200fx, 200fx)
pewpew.customizable_entity_set_mesh(background2, "/dynamic/polar_graphic.lua", 1)
